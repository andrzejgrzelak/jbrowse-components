...
_See code:
[src/commands/add-assembly.ts](https://github.com/GMOD/jbrowse-components/blob/v2.3.3/products/jbrowse-cli/src/commands/add-assembly.ts)_
...
_See code:
[src/commands/add-connection.ts](https://github.com/GMOD/jbrowse-components/blob/v2.3.3/products/jbrowse-cli/src/commands/add-connection.ts)_
...
_See code:
[src/commands/add-track.ts](https://github.com/GMOD/jbrowse-components/blob/v2.3.3/products/jbrowse-cli/src/commands/add-track.ts)_
...
_See code:
[src/commands/add-track-json.ts](https://github.com/GMOD/jbrowse-components/blob/v2.3.3/products/jbrowse-cli/src/commands/add-track-json.ts)_
...
_See code:
[src/commands/admin-server.ts](https://github.com/GMOD/jbrowse-components/blob/v2.3.3/products/jbrowse-cli/src/commands/admin-server.ts)_
...
_See code:
[src/commands/create.ts](https://github.com/GMOD/jbrowse-components/blob/v2.3.3/products/jbrowse-cli/src/commands/create.ts)_
...
_See code:
[src/commands/remove-track.ts](https://github.com/GMOD/jbrowse-components/blob/v2.3.3/products/jbrowse-cli/src/commands/remove-track.ts)_
...
_See code:
[src/commands/set-default-session.ts](https://github.com/GMOD/jbrowse-components/blob/v2.3.3/products/jbrowse-cli/src/commands/set-default-session.ts)_
...
_See code:
[src/commands/text-index.ts](https://github.com/GMOD/jbrowse-components/blob/v2.3.3/products/jbrowse-cli/src/commands/text-index.ts)_
...
_See code:
[src/commands/upgrade.ts](https://github.com/GMOD/jbrowse-components/blob/v2.3.3/products/jbrowse-cli/src/commands/upgrade.ts)_
